                ...
                <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
                  <div className="flex flex-col gap-16">
                    <article className="group relative flex flex-col items-start">
                      <h2 className="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-800">
                        ...
                        <a href="http://ciriec.es/valencia2022/wp-content/uploads/COMUN-158.pdf" target="noreferrer">
                          <span className="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                          <span className="relative z-10">
                            {fecth.data.article.article0.title}
                          </span>
                        </a>
                      </h2>
                      <time
                      ...
                      >
                        ...
                        <b>Artículos Publicados </b>,{" "}
                        {fecth.data.article.article0.date}
                        <br />
                      </time>
                      <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                        {fecth.data.article.article0.detail}
                      </p>
                      <div
                        aria-hidden="true"
                  ...
                  <div className="space-y-9 lg:pl-15 xl:pl-24">
                    <div className="rounded-2xl border border-zinc-100 p-5 dark:border-zinc-300/40">
                      ...
                      {Object.entries(fecth.data.works).map((value, idx) => (
                      ...
                      <a
                        ...
                        href="https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001989802" target="noreferrer"
                      >
